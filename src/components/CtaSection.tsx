          ...
          <div className="relative z-10 px-6 py-16 md:py-24 md:px-16 text-center md:text-left">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
              <AnimatedSection animation="slide-from-left">
                ...
                <Link 
                  to="/contact" 
                  className="inline-flex items-center bg-white text-primary px-6 py-3 rounded-md font-medium hover:bg-gray-100 transition-colors group"
                >
                ...
                <div className="relative">
                  <div className="aspect-square w-full max-w-sm mx-auto bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                    ...
                    <ul className="space-y-4">
                      {[
                        "A 30-minute discussion with a senior consultant",
                        "Initial assessment of your cultural challenges",
                        "Tailored recommendations for your situation",
                        "Framework for measuring cultural performance"
                      ].map((item, idx) => (
                        <li key={idx} className="flex items-start text-primary-foreground/90">
                  ...
                  <div className="absolute -bottom-6 -left-6 w-16 h-16 rounded-full bg-purple-500/30 animate-float" style={{ animationDelay: "1s" }}></div>
                </div>
              </AnimatedSection>
            </div>
          </div>

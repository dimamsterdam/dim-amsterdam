...
const MinimalistTestimonialsSection = () => {
  return <section className="py-16 bg-gradient-to-br from-[#e3eff6] to-[#f0f7fc] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="flex justify-center mb-8">
          <Link to="/referenties" className="group flex items-center gap-2 transition-colors hover:text-primary">
            <h2 className="text-2xl md:text-3xl font-display font-semibold text-center" contentEditable>Opdrachtgevers over DIM</h2>

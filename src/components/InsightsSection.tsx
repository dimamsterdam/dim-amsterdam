    ...
    <section className="section-padding">
      <div className="container mx-auto px-4 md:px-6">
        <AnimatedSection className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12">
          ...
          <Link 
            to="/insights" 
            className="group hidden md:flex items-center text-primary font-medium mt-6 md:mt-0 hover:text-primary/80 transition-colors"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {insights.map((insight, index) => (
            ...
            >
              ...
              >
                <div className={`h-full rounded-xl overflow-hidden border transition-all duration-300 ${
                  hoverIndex === index ? 'border-primary shadow-lg' : 'border-border'
                }`}>
                  ...
                  <div className="p-6">
                    ...
                    <div className={`flex items-center mt-4 text-primary transition-all duration-300 ${
                      hoverIndex === index ? 'opacity-100' : 'opacity-70'
                    }`}>
                      <span className="font-medium">Read more</span>
                      <ArrowRight className={`ml-2 w-4 h-4 transition-transform duration-300 ${
                        hoverIndex === index ? 'translate-x-1' : ''
                      }`} />
                    </div>
                  </div>
                </div>

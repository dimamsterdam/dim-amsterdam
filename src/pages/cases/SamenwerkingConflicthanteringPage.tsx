        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <AnimatedSection delay={0.1} className="prose prose-lg max-w-none">
              ...
              <p>
                Kern van het eerste deel van het traject betrof het verhelderen en verbeteren van de onderlinge werkverhouding 
                en taakverdeling tussen de organisatie-onderdelen. In het tweede deel van het traject lag de focus op de 
                implementatie en borgen van de gemaakte afspraken en werkwijze conform het reeds eerder ingezet 
              ...
              <p>
                ...
                op proces en doorvertaling naar eigen rol en vaardigheden.
              </p>

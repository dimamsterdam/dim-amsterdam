        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto">
            <AnimatedSection>
              ...
              <div className="mt-10 mb-12">
                <AspectRatio ratio={21 / 9} className="bg-muted overflow-hidden rounded-lg shadow-md">
                  <img src="/lovable-uploads/e7ae05c1-0045-4921-a819-7ba26c3bd89e.png" alt="Abstract geometric design with orange, white, and pink colors featuring circular and starburst elements" className="object-cover w-full h-full" />
                </AspectRatio>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.1} className="prose prose-lg max-w-none">
              ...
              <p>DIM ontwikkelde een beknopte aanpak van enkele bijeenkomsten. De opzet en begeleiding van de bijeenkomsten werden bewust en nadrukkelijk gekenmerkt door een afwisseling in interventie-niveaus: inhoud, reflectie op proces en doorvertaling naar eigen rol en vaardigheden.

            </p>
              
              <p>In het eerste deel werd aan de hand van een strakke methodiek een verdiepend en waarderend gesprek gevoerd in kleinere groepjes. Hiermee werd het onderling begrip versterkt en was er meer ruimte om naar elkaar te luisteren. Vervolgens zijn de knelpunten in een plenair gesprek verder onderzocht en 'afgepeld'. Op basis van meer inzicht in ieders overwegingen en intenties zijn excuses uitgesproken en gezamenlijke belangen en standpunten 'ontdekt'.

      ...
      <section id="top" className="relative py-20 md:py-24 bg-gradient-to-b from-white to-blue-50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto">
            <AnimatedSection>
              <h1 className="text-3xl sm:text-4xl font-display font-bold mb-2 break-words md:text-4xl">Case: ZBO Samenwerking & Conflict</h1>
              <h2 className="text-xl sm:text-2xl font-display text-gray-700 mb-6">
                Effectief samenwerken en conflicten overbruggen
              </h2>
              ...
              <div className="mt-10 mb-12">
                <AspectRatio ratio={21 / 9} className="bg-muted overflow-hidden rounded-lg shadow-md">
                  <img 
                    ...
                    alt="Abstract geometric design with collaboration and conflict resolution elements" 
            ...
            <AnimatedSection delay={0.1} className="prose prose-lg max-w-none">
              ...
              <p>Op basis van enkele gesprekken met de bestuurder zijn de volgende doelstellingen afgesproken:</p>
              ...
              <h2 className="text-2xl font-display font-bold mt-8 mb-4">Wat onze klanten zeggen</h2>
...
export default ZBOSamenwerkingPage;

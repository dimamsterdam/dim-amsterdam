          ...
          <div className="max-w-4xl mx-auto">
            ...
            <AnimatedSection delay={0.1} className="prose prose-lg max-w-none">
              ...
              <p>
                ...
                krapper, en de inzetbaarheid van de markt minder flexibel werd.
              </p>
              
              <p>
                De context en bovengenoemde ontwikkelingen tezamen zorgden ondermeer voor druk op de kwaliteit van dienstverlening, 
                de kostendekkendheid en verhoogde werkdruk. Verbetering van deze laatste elementen had dan ook prioriteit in de aanpak.
              </p>
